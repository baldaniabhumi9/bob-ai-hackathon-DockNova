...
| Track | **AI** | — |
| Lead | [LEAD NAME] | [lead.email@example.com] |
| Member | [MEMBER 2 NAME] | [member2.email@example.com] |
| Member | [MEMBER 3 NAME] | [member3.email@example.com] |

*(Fill in your actual team details — they are not part of the source project handbook.)*
